<template>
  <div class="row" v-if="mask >= 0">
    ...
    >
        ...
        <div class="text-center p-0 mr-1 col-lg-12 col-sm-12">
          ...
          <div class="text-center">
            <span
              ...
              :class="'hover-highlight-inner item-' + race.icon + (iconSmall ? '-sm' : '') + ' ' + (isRaceSelected(index) ? 'highlight-selected-inner' : '')"
            />
          </div>
        </div>
      </div>
      ...
      <div
        class="d-inline-block" v-if="displayAllNone && !allNoneBelow"
      ...
      >
        <div
          ...
          :class="'btn-xs eq-button-fancy ' + (parseInt(mask) >= 65535 ? 'eq-button-fancy-highlighted' : '')"
          @click="selectAll()"
        >
          All
        </div>
        <div
          ...
          :class="'btn-xs eq-button-fancy ' + (parseInt(mask) === 0 ? 'eq-button-fancy-highlighted' : '')"
          @click="selectNone()"
        >
          None
        </div>
