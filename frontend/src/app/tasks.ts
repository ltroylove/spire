...
export class Tasks {
  ...
  public static getFieldDescriptions() {
    return {
      ...
      "faction_reward": "Faction ID for reward",
      "faction_amount": "Amount of faction rewarded",
      ...
      "allowed_classes": "Class bitmask restriction for receiving the task. 0 and 65535 mean all classes are allowed. -1 means no classes are allowed.",
    }
  }
